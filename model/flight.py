...
class Flight:
    ...
    #@property serve per trasformare un metodo in un attributo.
    #Così puoi scrivere oggetto.ID invece di oggetto.get_ID()
    #È l’equivalente di un getter in Java, ma in stile Pythonico.
